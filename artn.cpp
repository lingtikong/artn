...
void ARTn::downhill()
{
  ...
  myreset_vectors();
  out_log << "After push over the saddle point, ecurrent = " << ecurrent << endl;
...
/* ---------------------------------------------------------------------------
 *  FIRE: fast interial relaxation engine
 * -------------------------------------------------------------------------*/
